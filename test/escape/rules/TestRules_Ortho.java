...
class TestRules_Ortho
{
	...
	{
		egb_game = new EscapeGameBuilder(new File("config/game/Game_Ortho.xml"));
	...
	public void testForError()
	{
		...
		assertEquals("Cannot Use the DIAGONAL Pattern on a Ortho Board", obs.getCause().getMessage());
	}
