...
class LocationInitializerTest
{
	...
	void test() throws Exception
	{
		String s = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n" + 
	        ...
	        LocationInitializer li = egi.getLocationInitializers()[0];
	        LocationInitializer test_li = new LocationInitializer(3,4,CLEAR, null, null);
	        assertTrue(test_li.toString().equals(li.toString()));
